...
$FROM    = 'formularz@hornetcut.pl'; // skrzynka do założenia w hPanelu, musi być na tej domenie
$SUBJECT = 'HornetCut: zapytanie ze strony';
...
$body = "Nowe zapytanie ze strony hornetcut.pl\n\n"
